...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='', help='models/yolo5m.yaml path')
    parser.add_argument('--data', type=str, default='data/furkan_ocr.yaml', help='data.yaml path')
    ...
    parser.add_argument('--project', default='runs/furkan_10_04_2021', help='save to project/name')
    parser.add_argument('--name', default='With_Aug', help='save to project/name')
